"""
Django settings for fala-q-eu-nao-te-escuto project.
...
ROOT_URLCONF = 'fala-q-eu-nao-te-escuto.urls'
...
WSGI_APPLICATION = 'fala-q-eu-nao-te-escuto.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.getenv('DJANGO_LOG_FILE', './fala-q-eu-nao-te-escuto.log'),
            'formatter': 'simple'
        },
    },
    'loggers': {
